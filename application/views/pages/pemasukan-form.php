                ...
                <div class="box box-danger">
                    <div class="box-body row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="customer_nama" <?=  isset($data) ? $data->customer_nama : '' ?>
                                class="form-control">
                        </div>
                        <div class="form-group col-md-6">
                            <label>Customer Telepon</label>
                            <input type="text" name="customer_phone" <?=  isset($data) ? $data->customer_phone : '' ?>
                                class="form-control">
                        </div>
                        <div class="form-group col-md-12">
                                    ...
                                    <tbody class="input-warp">
                                        <tr class="row-input">
                                            <td><select class="form-control deskripsi table-input item select-field"
                                                ...
                                                <?php foreach ($produk as $row) { ?>
                                                <option
                                                    <?= isset($data) && $data->produk == $row->id_produk ? 'selected' : '' ?>
